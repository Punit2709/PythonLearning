...
enter_city=Entry(root,textvariable=search_city,fg="black",font=("Arial",24,"bold"))
enter_city.pack()

search_button=Button(root,text='Search Weather',width=20,bg="white",font=("Arial",20,"bold"),command=print_weather)
search_button.pack()
